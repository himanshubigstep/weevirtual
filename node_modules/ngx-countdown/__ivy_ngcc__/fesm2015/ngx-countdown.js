...
CountdownTimer = __decorate([ __metadata("design:paramtypes", [NgZone])
], CountdownTimer);
...
CountdownGlobalConfig = __decorate([ __param(0, Inject(LOCALE_ID)),
...
CountdownComponent = __decorate([ __param(0, Inject(LOCALE_ID)),
